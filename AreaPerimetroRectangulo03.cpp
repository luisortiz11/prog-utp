//Nombre del Seudocodigo:AreaPerimetroRectangulo03
...
Imprimir("Perimetro del Rectangulo 2x%.2f + 2x%.2f = %.2f",base,altura, Area );
// Perimetro del Rectangulo 2base + 2altura= 9.4  //En Pantalla
//Imprimir("\n Area del Rectangulo base * altura= %.3f",Area);
Imprimir("\n Area del Rectangulo:  %.2f = %.2f x %.2f ",Area, base, altura);
